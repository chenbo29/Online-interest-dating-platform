...
class ActivityShowModel extends Model {
	  ...
	  protected $_validate=array(
                ...
                array('content','0,10000','活动内容过长！',0,'length'),
                array('addr','require',"地址不能为空，但您可以填写无等字样！"),
                array('begin_time','require',"活动时间不能为空！"),
                array('over_time','require',"活动结束时间不能为空！"),
	...
	public function uploadpastact($relpath){
			...
			if (!$this->create()){ // 指定新增数据
				...
				$this->content=htmlspecialchars_decode(I('post.content'));
