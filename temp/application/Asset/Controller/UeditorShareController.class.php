	...
	function upload(){
		...
		switch ($action) {
			case 'config':
				...
				/* 上传图片 */
			case 'uploadimage':
				$result = $this->_ueditor_upload(array('maxSize' =>5242880),$orgid);
				break;
				/* 上传涂鸦 */
			case 'uploadscrawl':
				...
				/* 上传视频 */
			case 'uploadvideo':
				$result = $this->_ueditor_upload(array('maxSize' =>1073741824 ,/*1073741824 1G*/'exts'  =>    array('mp4', 'avi', 'wmv','rm','rmvb','mkv')),$orgid);
				break;
				/* 上传文件 */
			case 'uploadfile':
				$result = $this->_ueditor_upload(array('maxSize' =>5242880),$orgid);
