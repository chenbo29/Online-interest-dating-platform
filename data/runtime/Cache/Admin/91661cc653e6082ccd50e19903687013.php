...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('user/add',array('orgid'=>$orgid));?>">添加管理员</a></li>
		</ul>
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('User/add_post',array('orgid'=>$orgid));?>">
				<fieldset>
					<div class="control-group">
						<label class="control-label">用户名:</label>
						<div class="controls">
							<input type="text" class="input"  name="user_login" placeholder="在这里输入要设置为管理员的用户名" value="">
						</div>
					</div>
