...
<![endif]-->
<link rel="stylesheet" href="/thinkcmfx/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--link rel="stylesheet" href="/thinkcmfx/statics/headNavbar.css"-->
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/thinkcmfx/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<div style="float:left;">
						<a style="height:40px;width:70px;"href="/thinkcmfx/index.php/admin/index/index/orgid/<?php echo ($orgid); ?>" class="brand"> 
					<img src="<?php echo sp_get_asset_upload_path($orginfo['logo']);?>">
				</a>
				</div>
				<div class="orgname"><span ><?php echo ($orginfo['name']); ?></span></div>
				
<!-- 				<div class="pull-left nav_shortcuts" >
					<div style="margin-top:6px;">
					<a class="btn btn-small btn-warning" href="/thinkcmfx/" title="前台首页" target="_blank">
						<i class="fa fa-home"></i>
					</a>
					
					<?php if(sp_auth_check(sp_get_current_admin_id(),'portal/AdminTerm/index','',$orgid)): ?><a class="btn btn-small btn-success" href="javascript:openapp('<?php echo U('portal/AdminTerm/index');?>','index_termlist','分类管理');" title="分类管理">
						<i class="fa fa-th"></i>
					</a><?php endif; ?>
					
					<?php if(sp_auth_check(sp_get_current_admin_id(),'portal/AdminPost/index','',$orgid)): ?><a class="btn btn-small btn-info" href="javascript:openapp('<?php echo U('portal/AdminPost/index');?>','index_postlist','文章管理');" title="文章管理">
						<i class="fa fa-pencil"></i>
					</a><?php endif; ?>

					
					<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache','',$orgid)): ?><a class="btn btn-small btn-danger" href="javascript:openapp('<?php echo U('admin/setting/clearcache');?>','index_clearcache','清除缓存');" title="清除缓存">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/thinkcmfx/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
							<span class="user-info">
								<small>欢迎,</small><?php echo ($Admin_Name); ?>
							</span>
							<i class="fa fa-caret-down"></i>
						</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/site','',$orgid)): ?><li>
									<a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','站点管理');"><i class="fa fa-cog"></i> 站点管理</a>
								</li><?php endif; ?>

							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/user/userinfo','',$orgid)): ?><li>
									<a href="javascript:openapp('<?php echo U('user/userinfo');?>','index_userinfo','个人资料');"><i class="fa fa-user"></i> 个人资料
									</a>
								</li><?php endif; ?>
							<li>
								<a href="<?php echo U('Public/logout');?>"><i class="fa fa-sign-out"></i> 退出</a>
							</li>
						</ul>
					</li>
				</ul>
	...
	<script src="/thinkcmfx/tpl_admin/simpleboot/assets/js/index.js"></script>
