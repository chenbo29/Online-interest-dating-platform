...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     <li><a href="<?php echo U('slide/index',array('orgid'=>$orgid));?>">所有风采</a></li>
     <li class="active"><a href="<?php echo U('slide/add',array('orgid'=>$orgid));?>">添加首页宣传图片</a></li>
  </ul>
  <form name="myform" id="myform" action="<?php echo U('slide/add_post',array('orgid'=>$orgid));?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table class="table table-bordered">
            ...
            <tr>
              <th width="80">图片名称:</th>
              <td>
              	<input type="text" style="width:400px;" name="slide_name" id="title" value="" class="input input_hd J_title_color" placeholder="请输入图片片名称" onkeyup="strlen_verify(this, 'title_len', 160)" />
              	<span class="must_red">*</span>
              </td>
            </tr>
            <!--
        	...
        	-->
             <tr>
              ...
              <td>
              	...
              	<textarea name='slide_content' id='description' style='width:98%;height:200px;'placeholder="您上传的图片可以是您的组织的宣传图片，也可以是近期举办活动的图片展示。在这里，您可以对图片添加详细的介绍。"  ></textarea>
              </td>
            </tr>
