			...
			<div class="span8">				
				<form class="form-horizontal J_ajaxForm" action="<?php echo U('user/register/doregister');?>" method="post">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="input_username" name="username" placeholder="请输入账号" class="span3" required>*<span style="margin-left:5px">由4-16位数字、字母或下划线组成</span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="input_email" name="email" placeholder="请输入邮箱" class="span3"required>*<span style="margin-left:5px">请输入邮箱，以便于找回丢失的密码</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" >所在城市</label>
						<div class="controls">
							<?php echo hook('J_China_City', array('province'=>0, 'city'=>2, 'district'=>3, 'community'=>4));?>
							*<span style="margin-left:5px">请选择您所在城市，便于查看您身边的社团！</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="input_password">密码</label>
						<div class="controls">
							<input type="password" id="input_password" name="password" placeholder="请输入密码" class="span3">*<span style="margin-left:5px">密码长度至少5位，最多20位</span>
						</div>
					</div>
