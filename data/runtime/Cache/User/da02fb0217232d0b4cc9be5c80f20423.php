...
#backtotop{position: fixed;bottom: 50px;right:20px;display: none;cursor: pointer;font-size: 50px;z-index: 9999;}jquery-1.7.2.js
...
<link href="/thinkcmfx/tpl/test/Public/css/stcss/joinst.css" rel="stylesheet">
</head>
 ...
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>
	...
	<a class="list-group-item" href="<?php echo u('comment/comment/index');?>"><i class="fa fa-comments-o"></i> 我的评论</a>
			...
			<div class="span9">
				...
				<form action="<?php echo U('User/St/searchst');?>" method="post">
					<div class="select">	
						<?php echo hook('J_China_City', array('province'=>0, 'city'=>2, 'district'=>3, 'community'=>4));?>
						<input type="submit" class="btn btn-primary query" value="搜索">
					</div>
					
				</form>
				<div>
				<?php if(is_array($allSt)): foreach($allSt as $key=>$v): ?><div class="span3" >
						<div class="thumbnail">
