...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" id="myform" action="<?php echo U('OrganizationAdmin/edittimeline',array('orgid'=>$orgid));?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
  ...
  <div class="col-auto">
    <div class="table_full">
      <table class="table table-bordered">
            <tr>
             ...
             <tr>
              <th width="80">时光内容:</th>
               <td>
              	<textarea name='content' style='width:98%;height:150px;' ><?php echo ($content); ?></textarea>
               </td>
            ...
            <tr> 
              ...
              <td>
                  <input type="text" name="timepoint"id="timepoint"value="<?php echo ($timepoint); ?>" data-date-format="yyyy-mm-dd hh:ii">
  	...
  	<div class="form-actions" style="margin-top:0px">
           <input class="btn btn-primary btn_submit J_ajax_submit_btn"type="submit"value="修改">
