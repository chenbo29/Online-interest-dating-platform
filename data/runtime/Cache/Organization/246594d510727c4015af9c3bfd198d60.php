	...
	<div class="container tc-main">
		<div class="row">
			<div class="span6 offset3">
				...
				<form class="form-horizontal J_ajaxForm" enctype="multipart" action="<?php echo U('organization/organization/create');?>" method="post">
					<div class="control-group">
						<label class="control-label" >组织名称：</label>
						<div class="controls">
							<input type="text" id="name" name="name" placeholder="请输入组织名称" class="span3">&nbsp;&nbsp;<span>*</span>
					...
					<div class="control-group">
						<label class="control-label" >组织规模：</label>
						<div class="controls">
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php echo hook('J_China_City', array('province'=>0, 'city'=>2, 'district'=>3, 'community'=>4));?>&nbsp;&nbsp;<span>*</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">设置审核问题：</label>
						<div class="controls">
							<textarea  name="issue" class="span3"placeholder="当其他用户申请加入这个组织时，需要回答的问题。"></textarea>
						</div>
					</div>
					<div class="control-group">
...
/*				if(data.isadmin==1){
	...
	<!-- /container <script src="/thinkcmfx/tpl/test/Public/js/jquery.form.js"></script>-->	
