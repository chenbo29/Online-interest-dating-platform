...
<!-- 			<div class="pull-right">
	...
	<div class="container tc-main">
		...
		<div class="row">
			<div class="span9">
				<div class="">
					<?php $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;where:org_id=$stid",5); ?>
					<?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>

						<div class="list-boxes">
							<h2>
								<a href="<?php echo leuu('article/index',array('stid'=>$_GET['stid'],'id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a>
							</h2>
							...
							<div>
								<div class="pull-left">
									<div class="list-actions">
										<a href="javascript:;"> <i class="fa fa-eye"></i>
											<span><?php echo ($vo["post_hits"]); ?></span>
										</a>
										<a href="<?php echo U('article/do_like',array('id'=> $vo['object_id']));?>" class="J_count_btn"> <i class="fa fa-thumbs-up"></i>
								...
								<a class="btn btn-warning pull-right" href="<?php echo leuu('article/index',array('stid'=>$_GET['stid'],'id'=>$vo['tid']));?>">查看更多</a>
							</div>
			...
			<div class="span3">
			<!-- 上传 -->
				<div class="tc-box launch">
					<div class="headtitle">
						<h2>我要上传</h2>
					</div>
					<div>
						<a class="launchRes" href="<?php echo U('UploadShare/uploadshare',array('typeid'=>$_GET['id'],'stid'=>$_GET['stid']));?>"><i class="fa fa-plus"></i>上传</a>
					</div>
			...
			<!-- 上传结束 -->
				...
				<div class="tc-box">
					...
					<div class="ranking">
						<?php $where['org_id']=$stid; $hot_articles=sp_sql_posts("cid:$portal_index_lastnews;field:post_title,post_excerpt,tid,smeta;order:post_hits desc;limit:5;",$where); ?>
						<ul class="unstyled">
					...
					<div class="tc-box">
						...
						<div class="comment-ranking">
							<?php $where1['post_table']="posts"; $last_comments=sp_get_comments("field:*;limit:0,5;order:createtime desc;",$where1); ?>
						...
						<ul class="list-unstyled tc-photos margin-bottom-30">
							<?php if(is_array($last_users)): foreach($last_users as $key=>$vo): ?><li>
									<a href="<?php echo U('user/index/index',array('id'=> $vo['id']));?>">
										<img alt="" src="<?php echo U('user/public/avatar',array('id'=>$vo['id']));?>"></a>
								</li><?php endforeach; endif; ?>
						</ul>
					</div>
					...
					<div class="tc-box">
						...
						<?php $where['org_id']=$stid; $last_post=sp_sql_posts("cid:$portal_last_post;field:post_title,post_excerpt,tid,smeta;order:listorder asc;limit:4;",$where); ?>
						<div class="posts">
								...
								<dl class="dl-horizontal">
									<dt>
										<a class="img-wraper" href="<?php echo U('article/index',array('id'=> $vo['tid']));?>">
											<?php if(empty($smeta['thumb'])): ?><img src="/thinkcmfx/tpl/test/Public/images/default_tupian4.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
												<?php else: ?>
									...
									<dd>
										<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>"><?php echo msubstr($vo['post_excerpt'],0,32);?></a>
									</dd>
