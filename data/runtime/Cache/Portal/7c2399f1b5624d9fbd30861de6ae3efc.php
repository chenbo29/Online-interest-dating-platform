        ...
        <div class="container">
            <h2><?php echo ($name); ?></h2>
             <div style="float:right;">
                ...
                <div class="uploadpic">
                    <a class="launchRes" href="<?php echo U('UploadShare/uploadshare',array('typeid'=>$_GET['id'],'stid'=>$_GET['stid']));?>"><i class="fa fa-plus"></i>我要上传</a>
                </div>
					...
					<div class="tc-gridbox">
                        <div class="header">
                      	...
                      	<?php if(!empty($smeta['thumb'])): ?><div class="item-image">
                      		    <a href="<?php echo leuu('article/index',array('stid'=>$_GET['stid'],'id'=>$vo['tid']));?>">
								<img  src="<?php echo sp_get_asset_upload_path($smeta['thumb']);?>" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>">
							</a>
						</div>
                      	<?php else: endif; ?>
                     
                            <h3>    <a href="<?php echo leuu('article/index',array('stid'=>$_GET['stid'],'id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a></h3>
                            <hr>
                        </div>
                        <div class="body">
                        	   <a href="<?php echo leuu('article/index',array('stid'=>$_GET['stid'],'id'=>$vo['tid']));?>"><?php echo (msubstr($vo["post_excerpt"],0,256)); ?></a>
                        </div>
                        <div class="footer">
