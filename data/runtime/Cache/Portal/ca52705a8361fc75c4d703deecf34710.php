	...
	<div class="row">
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
		    	...
		    	<div>
					<?php if(!empty($prev)): ?><a href="<?php echo U('article/index',array('id'=>$prev['tid'],'stid'=>$_GET['stid']));?>" class="btn btn-primary pull-left">上一篇</a><?php endif; ?>
					<?php if(!empty($next)): ?><a href="<?php echo U('article/index',array('id'=>$next['tid'],'stid'=>$_GET['stid']));?>" class="btn btn-warning pull-right">下一篇</a><?php endif; ?>
    	            <script type="text/javascript" src="/thinkcmfx/tpl/test/Public/js/qrcode.min.js"></script>
