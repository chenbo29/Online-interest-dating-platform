    ...
    <div class="row">
		<div class="span9">
			<div>
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h2><a href="<?php echo leuu('article/tieziDetail',array('stid'=>$_GET['stid'],'id'=>$vo['id']));?>"><?php echo ($vo["post_title"]); ?></a></h2>
					<p>
					...
					<div>
						<div class="pull-left">
							...
							<a href="<?php echo U('article/tiezi_do_like',array('stid'=>$_GET['stid'],'id'=>$vo['id']));?>" class="J_count_btn"><i class="fa fa-thumbs-up"></i><span class="count"><?php echo ($vo["post_like"]); ?></span></a>
							<!-- <a href="<?php echo U('user/favorite/tiezi_do_favorite',array('id'=>$vo['id']));?>" class="J_favorite_btn" data-title="<?php echo ($vo["post_title"]); ?>" data-url="<?php echo U('portal/article/index',array('id'=>$vo['tid']));?>" data-key="<?php echo sp_get_favorite_key('posts',$vo['object_id']);?>">
								<i class="fa fa-star-o"></i>
							</a> -->
							</div>
						</div>
						<a class="btn btn-warning pull-right" href="<?php echo leuu('article/tieziDetail',array('stid'=>$_GET['stid'],'id'=>$vo['id']));?>">查看更多</a>
					</div>
		...
		<div class="span3">
			<!-- 发帖 -->
				<div class="tc-box launch">
					...
					<div>
						<a class="launchRes" href="<?php echo leuu('list/launchPost',array('stid'=>$_GET['stid']));?>"><i class="fa fa-pencil-square-o"></i> 发帖</a>
					</div>
